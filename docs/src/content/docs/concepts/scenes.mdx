...
| `transparentBelow` | `false` | When `true`, scenes below this one still render. When `false` (the default), every below-stack scene tree is hidden — both world layers **and** screen-space UI/HUD. |
