...
const fade: Pick<EmitterConfig, "scale" | "alpha"> = {
...
const shapes = [
  { lifetime: 1, shape: "softCircle" }, // 64×64
  { lifetime: 1, shape: { type: "softCircle", size: 16 } }, // 16×16 texture
  { lifetime: 1, shape: { type: "circle", size: [32, 16] } }, // an ellipse
  { lifetime: 1, shape: { type: "line", size: [4, 32] } }, // a vertical streak
...
entity.add(
  new ParticleEmitterComponent(ParticlePresets.fire("assets/flame.png")),
);
```
