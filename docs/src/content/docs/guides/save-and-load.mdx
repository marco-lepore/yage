...
```typescript yage-group="save" yage-file="persistence/compound.ts"
...
```typescript yage-group="save" yage-file="persistence/stores.ts"
import {
  createRecord,
  createValue,
  createCounter,
...
```typescript yage-group="save" yage-file="example-3.ts"
...
```typescript yage-group="save" yage-file="example-4.ts"
import { createList } from "@yagejs/core";
...
```typescript yage-group="save" yage-file="example-5.ts"
import {
  createRecord,
  createCounter,
  createSet,
...
```typescript yage-group="save" yage-file="persistence/save.ts"
...
```typescript yage-group="save" yage-file="main.ts"
// game/main.ts
...
```typescript yage-group="save" yage-file="example-8.ts"
import { save } from "./persistence/save.js";
import { settings, saves } from "./persistence/stores.js";
...
```typescript yage-group="save" yage-file="example-9.ts"
import { save } from "./persistence/save.js";
import { settings, saves } from "./persistence/stores.js";
...
```typescript yage-group="save" yage-file="example-10.ts"
import { save } from "./persistence/save.js";
import { settings, saves } from "./persistence/stores.js";
...
```typescript yage-group="save" yage-file="example-11.ts"
import { save } from "./persistence/save.js";
import { settings, saves } from "./persistence/stores.js";
...
```typescript yage-group="save" yage-file="example-12.ts"
...
```typescript yage-group="save" yage-file="example-13.ts"
...
function number(value: unknown): number {
  if (typeof value !== "number" || !Number.isFinite(value)) {
    throw new Error("Save data contains an invalid number");
  }
  return value;
}
...
await save.restore("saves", saves, {
  ...
  migrate: (old, fromVersion) => {
    ...
    const position = record(v.position);
    if (!Array.isArray(v.inventory))
      throw new Error("Inventory must be an array");
    const inventory = v.inventory.map((item: unknown) => {
      if (typeof item !== "string")
        throw new Error("Inventory item must be a string");
      return item;
    });
    return {
...
await save.restore("run", game, {
  ...
  migrate: (old) => {
    const v1 = record(old);
    return { gold: number(v1.gold), day: { value: 7 } };
  },
});
```
...
```typescript yage-group="save" yage-file="example-14.ts"
import { jsonCodec, setCodec, mapCodec, dateCodec } from "@yagejs/core";

jsonCodec<{ score: number }>(); // Codec<T, T>             — identity (default)
...
```typescript yage-group="save" yage-file="example-15.ts"
import { localStorageAdapter, memoryAdapter } from "@yagejs/save";

localStorageAdapter({ namespace: "my-game" }); // browser
...
```typescript yage-group="save" yage-file="example-16.ts"
