...
The addon does not supply a generic stats/buff/resource system, AI decision
logic, a generic motion controller, tag-based loadout filtering, hierarchical
or stateful tag rules, transient combat save state, or built-in presenters.
These remain game policy or later additions to the existing public boundaries.
