...
library plugs into dialogue through its `I18nAdapter` option, with or without
this addon (see the dialogue page).
...
```ts
import type { MessageResolver, Relocalizable } from "@yagejs-addons/i18n";
