...
```ts yage-group="cue-options" yage-context="entity"
import type { ParticleEmitterComponent } from "@yagejs/particles";
import type { SpriteComponent } from "@yagejs/renderer";
import { feelDelay, feelParallel, feelSequence } from "@yagejs-addons/feel";
import { feelScalePunch } from "@yagejs-addons/feel/renderer";
import { feelSound } from "@yagejs-addons/feel/audio";
import { feelParticleBurst } from "@yagejs-addons/feel/particles";

declare const pickupSprite: SpriteComponent;
declare const glitter: ParticleEmitterComponent;
...
import { Feel, feelLoop, feelParallel } from "@yagejs-addons/feel";
import { feelFlightLines, feelMotionTrail } from "@yagejs-addons/feel/renderer";
...
declare const weaponSprite: SpriteComponent;
declare const aimDirection: Vec2Like;
...
import type { SpriteComponent } from "@yagejs/renderer";
import { feelParallel } from "@yagejs-addons/feel";
import { feelGlow, feelOutline } from "@yagejs-addons/feel/renderer";
...
```ts
import type { Entity } from "@yagejs/core";
import { feelParallel, feelSlowMotion, feelTargetFreeze } from "@yagejs-addons/feel";
...
declare const enemyAnimations: AnimationController;
...
```ts
import type { SpriteComponent, VisualTransformModifierHandle } from "@yagejs/renderer";
