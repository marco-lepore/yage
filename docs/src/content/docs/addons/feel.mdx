...
The [Feel addon example](https://examples.yage.dev/feel-addon.html) shows
impact feedback, flight lines, a motion trail, animated highlights, camera
modifiers, and a custom effect.
