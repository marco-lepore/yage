...
effects across three scenes. It covers impacts, trails, afterimages,
...
implosion, a recipe, and a custom effect. Press `N` or `P` to move between
scenes with a slide transition.
...
`voidCollapse` combines implosion and inward zoom blur. It does not add a
burst, particles, camera movement, sound, entity destruction, or other
