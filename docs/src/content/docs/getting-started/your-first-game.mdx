...
description: "Create a spinning triangle with a scene and a component"
---

import GameEmbed from '../../../components/GameEmbed.astro';

In this guide you will create a spinning green triangle from scratch with
a scene and a component that rotates the triangle each frame.
