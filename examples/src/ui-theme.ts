...
export function textStyle(
  ...
  const base = (() => {
    switch (preset) {
      case "title":
        return { fontFamily: FONT_REGULAR, fontSize: 22, fill: 0xffffff };
      case "subtitle":
        return { fontFamily: FONT_NARROW, fontSize: 13, fill: 0x64748b };
      case "label":
        return {
      ...
      case "body":
        return { fontFamily: FONT_NARROW, fontSize: 14, fill: 0xe2e8f0 };
      case "caption":
        return { fontFamily: FONT_NARROW, fontSize: 11, fill: 0x94a3b8 };
      case "button":
        return { fontFamily: FONT_NARROW, fontSize: 14, fill: 0xffffff };
      case "buttonSmall":
        return { fontFamily: FONT_NARROW, fontSize: 13, fill: 0xffffff };
      case "dark":
        return { fontFamily: FONT_NARROW, fontSize: 13, fill: 0x333333 };
    }
  })();
