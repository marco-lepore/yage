...
- [#374](https://github.com/marco-lepore/yage/pull/374) [`ba12b2f`](https://github.com/marco-lepore/yage/commit/ba12b2f0f851c2472abed23878b9598e57024d5f) Thanks [@marco-lepore](https://github.com/marco-lepore)! - `setVisible` accepts `"auto"`, the same three values as the `visible` option. `"auto"` reads the device through `prefersTouchControls()`, so a settings screen offering "on / off / automatic" passes its choice straight through with no branch of its own.
