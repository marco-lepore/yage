/**
 * Font plumbing shared by the renderer-backed presenters: every view renders
 * incidental text (titles, labels, quantities) the same way — an optional
 * baked bitmap font wins, else the canvas family + resolution. One
