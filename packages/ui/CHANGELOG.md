...
- [#304](https://github.com/marco-lepore/yage/pull/304) [`daa8214`](https://github.com/marco-lepore/yage/commit/daa821458a69d14176f5c5aebc3f4204348ddb0c) Thanks [@marco-lepore](https://github.com/marco-lepore)! - Remove automatic UI component snapshot methods and serialized UI-tree data.
  Rebuild presentation from explicit game state instead of persisting live UI
  objects.
...
- [#316](https://github.com/marco-lepore/yage/pull/316) [`8551fc3`](https://github.com/marco-lepore/yage/commit/8551fc31311c44aed8e81f85782dbfb1dc5e2f58) Thanks [@marco-lepore](https://github.com/marco-lepore)! - UI elements now keep their documented update, input, and teardown contracts.
...
- [#347](https://github.com/marco-lepore/yage/pull/347) [`d951322`](https://github.com/marco-lepore/yage/commit/d951322da3dff3adfc532732f1578cc6f1149fa7) Thanks [@marco-lepore](https://github.com/marco-lepore)! - Size a `UIImage` on one axis and the other axis follows the texture.
...
- [#340](https://github.com/marco-lepore/yage/pull/340) [`56570ae`](https://github.com/marco-lepore/yage/commit/56570ae539b98d2eefa000898c71eabea28df571) Thanks [@marco-lepore](https://github.com/marco-lepore)! - `attachTooltip`'s documented escape hatch for custom popovers acquires the floating overlay with `scene.use(FloatingOverlayKey)`, the public scope-aware read, instead of an internal alias that returns `undefined` when the overlay is absent.

- [#307](https://github.com/marco-lepore/yage/pull/307) [`c105024`](https://github.com/marco-lepore/yage/commit/c105024b5402c11dc36da52b08f6ab39354da8a5) Thanks [@marco-lepore](https://github.com/marco-lepore)! - `LoadingSceneProgressBar` subscribes to `scene:loading:progress` through `Component.listenBus`. Behaviour is unchanged.
...
- [#213](https://github.com/marco-lepore/yage/pull/213) [`f48983d`](https://github.com/marco-lepore/yage/commit/f48983dbb4e43c25b455ac3f96e7d8684266bbc3) Thanks [@marco-lepore](https://github.com/marco-lepore)! - Cache stable floating-overlay layout between frames and add `FloatingHandle.invalidateLayout()` for imperative content updates.
