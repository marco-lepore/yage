...
- [#304](https://github.com/marco-lepore/yage/pull/304) [`daa8214`](https://github.com/marco-lepore/yage/commit/daa821458a69d14176f5c5aebc3f4204348ddb0c) Thanks [@marco-lepore](https://github.com/marco-lepore)! - Remove particle-emitter snapshot methods and serialized config types. Particle
  simulation and renderer resources are runtime state; persist only the domain
  values needed to reconstruct an emitter.

- [#294](https://github.com/marco-lepore/yage/pull/294) [`9b9fe07`](https://github.com/marco-lepore/yage/commit/9b9fe07d7f32219c0e9aa37265b526cdc5924ce8) Thanks [@marco-lepore](https://github.com/marco-lepore)! - Add independently owned particle-emission requests.
...
- [#312](https://github.com/marco-lepore/yage/pull/312) [`439d0e2`](https://github.com/marco-lepore/yage/commit/439d0e205228bee15d8d79607abdba5731b0873b) Thanks [@marco-lepore](https://github.com/marco-lepore)! - An emitter's container follows its entity, which makes emitters depth-sort and adds local-space simulation; a ring spawn with radial speed; numeric config validated at construction.
