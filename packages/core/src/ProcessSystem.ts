...
/**
 * Built-in system that ticks all ProcessComponents on entities in the active
 * scene, plus a scene-level set of global processes.
 *
...
export class ProcessSystem extends System {
  ...
  /** Time scale multiplier. 1.0 = normal, 0.5 = half speed, 0 = paused. */
  timeScale = 1;
