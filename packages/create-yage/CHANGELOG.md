...
- [#340](https://github.com/marco-lepore/yage/pull/340) [`56570ae`](https://github.com/marco-lepore/yage/commit/56570ae539b98d2eefa000898c71eabea28df571) Thanks [@marco-lepore](https://github.com/marco-lepore)! - The scaffolded `AGENTS.md` shows the Inspector's entity lookup under its current name, `getEntity`, which takes an entity id as well as a name.
