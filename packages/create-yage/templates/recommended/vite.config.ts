  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        // Installed on Android, the game also hides the status and
        // navigation bars. iOS ignores display_override and opens the game
        // "standalone", without browser toolbars.
        display: "standalone",
