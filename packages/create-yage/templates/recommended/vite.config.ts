...
export default defineConfig({
  // vite-plugin-wasm is required by @yage/physics, which depends on
  ...
  oxc: {
    ...
    // @yage/save later and put @serializable on your own components, it Just
    // Works without a config change. Not strictly required today — all
    // @yage/* packages are pre-transpiled and their dists contain no raw
