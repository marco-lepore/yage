...
- [#304](https://github.com/marco-lepore/yage/pull/304) [`daa8214`](https://github.com/marco-lepore/yage/commit/daa821458a69d14176f5c5aebc3f4204348ddb0c) Thanks [@marco-lepore](https://github.com/marco-lepore)! - Remove automatic React UI root snapshot support. UI trees are reconstructed
  from explicit application state after loading.
...
- [#316](https://github.com/marco-lepore/yage/pull/316) [`8551fc3`](https://github.com/marco-lepore/yage/commit/8551fc31311c44aed8e81f85782dbfb1dc5e2f58) Thanks [@marco-lepore](https://github.com/marco-lepore)! - React UI trees preserve keyed child order without duplicate root or container entries.

  `ScrollView` now forwards its ref to the `UIScrollView` instance. `useSplitText` also reconnects its split listener when React replaces the underlying node.
